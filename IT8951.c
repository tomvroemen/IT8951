...
void IT8951_RIPPLE_Info(uint32_t x, uint32_t y,char *string, uint8_t scale)
{
	...
	IT8951DisplayArea(x,y, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+1, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+2, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+3, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+4, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+5, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+6, 8*scale*strlen(string), 2*scale, 2);
	IT8951DisplayArea(x,y+7, 8*scale*strlen(string), 2*scale, 2);
}
