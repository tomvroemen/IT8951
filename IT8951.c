...
void IT8951_RIPPLE_Info(uint32_t x, uint32_t y,char *string, uint8_t scale)
{
	...
	IT8951DisplayArea(x,y, 200, 16*scale, 2);
}
...
void IT8951_BMP_Example(uint32_t x, uint32_t y,char *path)
{
	...
	EPD_DrawLine(450, 150, 200, 100, 0x00);
	EPD_DrawLine(350, 300, 200, 500, 0x00);
	EPD_DrawLine(450, 450, 600, 500, 0x00);
	EPD_DrawLine(300, 550, 600, 500, 0x00);
